...
const Login = () => {
  ...
  return (
    <View style={[styles.loginContainer, { paddingBottom: insets.bottom }]}>
      ...
      <View>
        <Button textColor="grey" onPress={() => navigation.navigate('ForgotPassword')}>
          <Text>Şifreni mi unuttun ?</Text>
        </Button>
      </View>
      <View>
        <Button textColor="grey" onPress={() => navigation.navigate('Register')}>
          <Text>
            {' '}
            Hesabın yok mu ? <Text style={{ color: COLORS.text }}>Kaydol</Text>
          </Text>
        </Button>
      </View>
