...
export const GetE_F_Category = createAsyncThunk('getFCategory', async (data) => {
...
export const GetE_F_CityCategory = createAsyncThunk('getFCityCategory', async (data) => {
...
export const GetE_F_DateCategory = createAsyncThunk('getFDateCategory', async (data) => {
...
export const GetE_F_DateCity = createAsyncThunk('getFDateCity', async (data) => {
...
export const GetE_F_DateCityCategory = createAsyncThunk('getFDateCityCategory', async (data) => {
...
export const discoverySlice = createSlice({
  ...
  reducers: {
    MarkEventAsRegistered: (state, action) => {
      ...
      const event = state.discoveryEvents.events.find((e) => e.eventId === eventId);
      if (event) {
